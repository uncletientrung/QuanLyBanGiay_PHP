  ...
  <div class="bg-image" style="background-image: url('<?php echo $dm->assets_folder; ?>/media/various/bg_side_overlay_header.jpg');">
    <div class="bg-primary-op">
      <div class="content-header">
        <!-- User Avatar -->
        <a class="img-link me-1" href="<?php echo APP_ADMIN_PATH; ?>profile">
        ...
        <!-- User Info -->
        <div class="ms-2">
          <a class="text-white fw-semibold" href="<?php echo APP_ADMIN_PATH; ?>profile">George Taylor</a>
        ...
        <div class="tab-pane pull-x fade fade-up" id="so-people" role="tabpanel" aria-labelledby="so-people-tab" tabindex="0">
          <div class="block mb-0">
            ...
            <div class="block-content">
              <ul class="nav-items">
                <li>
                  <a class="d-flex py-2" href="<?php echo APP_ADMIN_PATH; ?>profile">
