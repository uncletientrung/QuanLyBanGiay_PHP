...
if (isset($Plugin["datatables"]) && $Plugin["datatables"] == 1) {
    ...
    $dm->get_js('js/plugins/datatables-buttons-jszip/jszip.min.js');
    $dm->get_js('js/plugins/datatables-buttons-pdfmake/pdfmake.min.js');
    $dm->get_js('js/plugins/datatables-buttons-pdfmake/vfs_fonts.js');
