...
#### 2. Quản lý người dùng: 
- Hiển thị danh sách thông tin khách hàng
- Thêm tài khoản -> Khởi tạo mật khẩu
- Reset mật khẩu
- Khóa / mở khóa tài khoản
#### 3. Quản lý danh mục sản phẩm
- Thêm loại sản phẩm (cho button (...) cạnh combobox, bấm vào phát thì ra dialog thêm loại sp) 
...
#### 4. Quản lý nhập hàng, lập phiếu nhập hàng: (1 phiếu nhập có thể nhập cho nhiều sản phẩm)
...
#### 6. Quản lý đơn đặt hàng của khách hàng
